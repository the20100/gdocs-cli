...
// update self-updates the gdocs binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/gdocs-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gdocs to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gdocs-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gdocs")
